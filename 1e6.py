...
if __name__ == '__main__':
    writer_train = SummaryWriter('cl/learning_rate_1e6_train')
    writer_test = SummaryWriter('cl/learning_rate_1e6_test')
    best_model_dir = 'model/1e6/best_model.pth'
    last_model_dir = 'model/1e6/last_model.pth'
    device = torch.device("cuda:7" if torch.cuda.
